...
from guimauve.gui.element_editor.widgets.text.test_dialog import TextTestDialog
from guimauve.gui.element_editor.workers.text import TextWorker
...
class TestButton(QToolButton):
    ...
    def _trigger_capture(self, delay=0):
        ...
        self.test_dialog = TextTestDialog(default)
    ...
    def _on_test_requested(self, params):
        ...
        self.worker = TextWorker(qpixmap_to_ndarray(self.overlay.full_screenshot), text, params)
